def GetRatings(data):
    ...
    rating_out_of_hundred = (
                product_quality_one + product_quality_two + customer_service + ordering_one + ordering_two + install_setup + order_again + receive_product + arrive_ontime + damaged_rating + maintenance)
